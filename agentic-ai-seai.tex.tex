...
\begin{frame}{7. RAG within Agents (Knowledge Augmentation)}
    ...
    \begin{itemize}
        ...
        \item \textbf{Retrieval Metric:} Recall@K (Did we retrieve the right document?).
        \item \textbf{Generation Metric:} Faithfulness (Did we hallucinate beyond retrieved content?).
    \end{itemize}
    
    \textbf{Advanced RAG for Agents:}
    \begin{itemize}
        \item \textit{Self-Querying:} Agent converts "Sold houses in Seattle" into SQL/metadata filters  
