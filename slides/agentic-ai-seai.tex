...
A \textbf{Markov Decision Process (MDP)} formalizes decision-making in stochastic environments.
...
% SLIDE 6
\begin{frame}{Partially Observable Markov Decision Processes (POMDP)}
...
\textbf{Consequence:}
Decision-making must account for \textbf{uncertainty about the state}.
\end{frame}
