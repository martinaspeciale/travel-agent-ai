...
% SLIDE 30 — Common Agent Frameworks in Practice
...
% SLIDE 31 — Practice: LangChain Tool Calling
...
% SLIDE 32 — Practice: LangGraph State Machine
...
% SLIDE 33 — Practice: LangChain vs LangGraph
...
% SLIDE 34 — Protocols: MCP vs A2A (Overview)
...
% SLIDE 35 — MCP: Client–Host–Server architecture
...
% SLIDE 36 — A2A: Agent-to-Agent protocol
...
% SLIDE 37 — MCP vs A2A vs Frameworks
...
% SLIDE 38 — When to use (or not use) MCP/A2A
